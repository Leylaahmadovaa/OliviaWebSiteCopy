...
import { faLessThan, faCartShopping, faMagnifyingGlass } from '@fortawesome/free-solid-svg-icons';
...
export default function Header(){
    ...
    <div className='flex justify-between px-[80px] py-[15px] items-center'>
        <img src="https://olivia.az/media/logo/stores/2/Logo_desktop.png" alt="Olivia Logo" className='h-[30px]'/>
        <div className='w-[830px] border-[1px] border-black  flex items-center px-[20px]'>
            ...
            <input placeholder='Axtarış...' type="text" className='border-none outline-none h-[41px] px-[10px]'/>
        </div>
