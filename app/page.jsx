...
export default function Home() {
  ...
  function handleChangeCategoryAtSatisLiderleri(category) {
    dispatch(
      categoryAtSaleLeadersActions.changeCategoryAtSaleLeaders(category)
    );
  ...
  useEffect(() => {
    ...
    if (savedCategory) {
      dispatch(
        categoryAtSaleLeadersActions.changeCategoryAtSaleLeaders(savedCategory)
      );
    }
  }, [dispatch]);
      ...
      <div className="bg-[#eeeff1] py-[30px] mt-[20px]">
        ...
        <div className="ml-[75px] mt-[20px]">
          ...
          <ul className="flex gap-[30px] text-[18px] h-[40px]">
            <li
              onClick={() =>
                handleChangeCategoryAtSatisLiderleri("Kirpiklər üçün tuş")
              }
              className="cursor-pointer hover:border-b-[1px] pb-[10px] border-black hover:text-black hover:translate-y-[-1px]"
              style={{
                color:
                  categoryAtSaleLeaders == "Kirpiklər üçün tuş"
                    ? "black"
                    : "gray",
                fontWeight:
                  categoryAtSaleLeaders == "Kirpiklər üçün tuş" ? "600" : "400",
              }}
            >
              Kirpiklər üçün tuş
            </li>
            <li
              onClick={() =>
                handleChangeCategoryAtSatisLiderleri("Dodaqlar üçün")
              }
              className="cursor-pointer hover:border-b-[1px] pb-[10px] border-black hover:text-black hover:translate-y-[-1px]"
              style={{
                color:
                  categoryAtSaleLeaders == "Dodaqlar üçün" ? "black" : "gray",
                fontWeight:
                  categoryAtSaleLeaders == "Dodaqlar üçün" ? "600" : "400",
              }}
            >
              Dodaqlar üçün
            </li>
            <li
              onClick={() =>
                handleChangeCategoryAtSatisLiderleri("Tonal kremlər")
              }
              className="cursor-pointer hover:border-b-[1px] pb-[10px] border-black hover:text-black hover:translate-y-[-1px]"
              style={{
                color:
                  categoryAtSaleLeaders == "Tonal kremlər" ? "black" : "gray",
                fontWeight:
                  categoryAtSaleLeaders == "Tonal kremlər" ? "600" : "400",
              }}
            >
              Tonal kremlər
            </li>
            <li
              onClick={() =>
                handleChangeCategoryAtSatisLiderleri("Konsilerlər")
              }
              className="cursor-pointer hover:border-b-[1px] pb-[10px] border-black hover:text-black hover:translate-y-[-1px]"
              style={{
                color:
                  categoryAtSaleLeaders == "Konsilerlər" ? "black" : "gray",
                fontWeight:
                  categoryAtSaleLeaders == "Konsilerlər" ? "600" : "400",
              }}
            >
              Konsilerlər
            </li>
            <li
              onClick={() =>
                handleChangeCategoryAtSatisLiderleri("Göz laynerləri")
              }
              className="cursor-pointer hover:border-b-[1px] pb-[10px] border-black hover:text-black hover:translate-y-[-1px]"
              style={{
                color:
                  categoryAtSaleLeaders == "Göz laynerləri" ? "black" : "gray",
                fontWeight:
                  categoryAtSaleLeaders == "Göz laynerləri" ? "600" : "400",
              }}
            >
              Göz laynerləri
            </li>
          ...
          <div className="h-[450px]">
            ...
            {products && products.length && (
              <div className="mt-[30px]">
                {products.some(
                  (product) => product.category === categoryAtSaleLeaders
                ) ? (
                  <Carousel
                    slidesToShow={6}
                    arrows={true}
